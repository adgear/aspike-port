...
CFILES="rw_command.c ei.c aerocalls.c"
...
CC_FLAGS="-DAS_USE_LIBUV -std=gnu99 -g -Wall -fPIC -O3 -fno-common -fno-strict-aliasing -D_FILE_OFFSET_BITS=64 -D_REENTRANT -D_GNU_SOURCE  -march=nocona -D_DARWIN_UNLIMITED_SELECT"
...
cmd="gcc $CC_FLAGS -o ../../priv/aspike_port $CFILES $INCLUDES  $LD_FLAGS"
echo $cmd
$cmd
